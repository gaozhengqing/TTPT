...
class StanfordCars(DatasetBase):
    ...
    def __init__(self, cfg):
        ...
        train_base, _, _ = OxfordPets.subsample_classes(train, val, test, subsample="base")
        _, self.classnames_base = self.get_lab2cname(train_base)
        train_new, _, _ = OxfordPets.subsample_classes(train, val, test, subsample="new")
        _, self.classnames_new = self.get_lab2cname(train_new)
